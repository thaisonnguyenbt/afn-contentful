...
class SingleFilterLisingPageTemplate extends React.Component {
    constructor(props) {
        super(props);
...
SingleFilterLisingPageTemplate.propTypes = propTypes;
SingleFilterLisingPageTemplate.defaultProps = defaultProps;
